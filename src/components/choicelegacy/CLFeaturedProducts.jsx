    ...
    <section id="cl-featured" className="py-10 md:py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
          ...
          <Link to="/search?q=beauty" className="flex items-center gap-1.5 text-sm font-semibold
        ...
        {/* Cart toast — links to real cart page */}
        {cartCount > 0 && (
          <Link
            to="/cart"
            className="fixed bottom-6 right-6 z-50 text-white text-sm font-semibold
              px-5 py-3 rounded-full shadow-xl flex items-center gap-2 hover:opacity-90 transition"
