      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/search?q=beauty" className="flex items-center gap-1.5 text-sm font-semibold text-[#D4527A] hover:gap-2.5 transition-all">
        ...
        {/* Cart toast */}
        {cartCount > 0 && (
          <Link to="/cart" className="fixed bottom-6 right-6 z-50 bg-[#D4527A] text-white text-sm font-semibold
            px-5 py-3 rounded-full shadow-xl flex items-center gap-2 hover:bg-[#b8416a] transition">
